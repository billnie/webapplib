...
g++ uppb.cpp hexdump.c  log_logstores.pb-c.c -lcgicc -lz -llz4 -lprotobuf-c -lwebapp -lmysqlclient -I/usr/include -I/usr/local/include/protobuf-c/ -I/usr/local/include/webapplib -I/usr/include/mysql -L/usr/lib/mysql
